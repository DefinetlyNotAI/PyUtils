...
import datetime
from TerminalPrint.colors import TPrintColors
...
class TPrint:
    ...
    def __init__(self,
        ...
        if not isinstance(color_scheme, (dict, type(None))):
            raise TypeError(f"Expected 'color_scheme' to be a dictionary or None, got {type(color_scheme).__name__}")
